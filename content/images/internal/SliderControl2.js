                    ...
                    if(_options.range){
                        ...
                        for (i = ui.values[0]; i <= ui.values[1]; i++){
                           if(_options.markers[i]) {
                               h = _options.markers[i]
                               map.addLayer( h);
                               fg.addLayer( h);
                               // h.bindPopup("<b>Hello world!</b><br>I am a popup.").openPopup();
                               // by stefan haslinger:
                               h.bindPopup("<a href=" + _options.markers[i].feature.properties.href +">"+
                                                        _options.markers[i].feature.properties.text +"</a>").openPopup();
